...
class AgoraVideoPinngleButtons extends StatefulWidget {
  ...
  const AgoraVideoPinngleButtons({
    Key? key,
  ...
  @override
  State<AgoraVideoPinngleButtons> createState() =>
      _AgoraVideoPinngleButtonsState();
}

class _AgoraVideoPinngleButtonsState extends State<AgoraVideoPinngleButtons> {
  ...
  Widget _switchCameraButton() {
    return widget.switchCameraButtonChild != null
        ...
        : AgoraCustomButton(
            ...
            assetIcon: Assets.flipAgoraIcon,
            buttonName: "flip",
          );
  }
